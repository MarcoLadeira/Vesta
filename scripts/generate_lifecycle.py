...
SCHEMA_PATH = ROOT / "vestahub" / "lifecycle_schema.json"
GENERATED_NOTICE = (
    "Generated by scripts/generate_lifecycle.py from "
    "vestahub/lifecycle_schema.json. DO NOT EDIT."
)
...
(function (global) {{
  ...
  global.VestaLifecycle = Object.freeze(data);
...
def render_all(schema: Mapping[str, Any]) -> dict[Path, str]:
    ...
    return {
        ROOT / "vestahub" / "generated_lifecycle.py": _render_python(
            schema, transitions
        ),
        ROOT / "vesta" / "assets" / "web" / "generated-lifecycle.js": _render_browser(
            schema, transitions
        ),
        ROOT / "vestahub" / "data" / "lifecycle-fixtures.json": _render_fixture(
            schema, transitions
        ),
