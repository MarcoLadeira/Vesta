...
from vestahub.owner_lease import new_lease, owned_by_this_process
from vestahub.owner_lease import touch as touch_lease
...
def legacy_recents_path() -> Path:
    ...
    return Path.home() / ".vesta" / "gui_recents.json"
...
def thread_status_for_result(
    ...
    lived only in vesta.gui_web, reachable by GUI turns alone.
