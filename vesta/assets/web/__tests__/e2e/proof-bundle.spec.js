...
test("production proof exports require scoped approval before writing", async ({ page }) => {
  ...
  await expect(page.locator(".approval-card")).toContainText(".vestahub/proof-bundle.json");
  ...
  await expect(page.locator(".approval-card").last()).toContainText(".vestahub/proof-bundle.md");
