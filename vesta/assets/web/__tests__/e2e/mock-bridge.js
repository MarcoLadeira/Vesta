...
(function () {
  ...
  var defaultBoot = {
    ...
    update: {
      ...
      policy: {
        ...
        automatic_install_on_quit: false, channel: "stable", owner: "vesta",
      },
    ...
    connections: [],
    modelOverrides: { global: true, path: "~/.vesta/models.json", providers: {}, hidden: {}, errors: [] },
  ...
  var scenario = window.__VESTA_TEST_SCENARIO__ || {};
  ...
  var bridge = {
    ...
    saveModelOverrides: function (payload, cb) {
      ...
      var report = { global: true, path: "~/.vesta/models.json", providers: providers, hidden: hidden, errors: [] };
    ...
    attachImage: function (data, name, cb) {
      ...
      cb(JSON.stringify({
        ok: true,
        path: ".vestahub/attachments/shot-" + index + ".png",
    ...
    pickImages: function (cb) {
      ...
      cb(JSON.stringify(scenario.pickedImages || {
        ok: true,
        images: [{ path: ".vestahub/attachments/picked.png", name: "picked.png", bytes: 64 }],
        rejected: 0,
      }));
    },
