...
export const MOCK_PATH = "vesta/assets/web/__tests__/e2e/mock-bridge.js";
export const APP_PATH = "/vesta/assets/web/index.html";
...
export async function finishRequest(page, requestId, result = {}) {
  ...
  await page.waitForFunction(
    (id) => window.__vesta?.state?.currentRequest !== id,
    requestId,
  );
}
