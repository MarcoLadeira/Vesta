// Mirrors vesta.gui_nav.nav_groups(): Chat is the only listed item. Prompt
...
export const SETTINGS = {
  ...
  providerUsage: [
    ...
    },
    {
      ...
      window: { type: "daily", label: "Daily requests (free tier)", seconds: 86400, metric: "requests" },
      official: { available: false },
      vestaTracked: { calls: 0, tokens: 0, tasks: 0, windowLabel: "Today" },
...
export function fullScenario(overrides = {}) {
  const base = {
    boot: {
      ...
      models: MODELS,
      selectedModel: "auto",
      // Mirrors vestahub.gui_preferences.MODES, which is what gui_web actually
