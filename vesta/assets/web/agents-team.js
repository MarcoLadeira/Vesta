(function (global) {
  ...
  global.VestaAgentsTeam = { feedHtml, panelHtml, mountPanel, stripHtml, name, avatar, agents, actorId, modelOptions, state, settle, conversationHtml, activities, currentActivity, attentionHtml };
