...
from vesta.model_registry import display_map as _display_map
...
def redact_secrets(detail: Any) -> str:
    ...
    and drifted from ``vestahub.command_runner.redact`` (the canonical
...
# vesta.model_registry (#170) — kept identical to the previous hardcoded tables.
