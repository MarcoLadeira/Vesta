...
Vesta supports more than one desktop window, including windows for different
...
This means opening a second Vesta window does not create partially written JSON
