...
Both halves already existed *in aggregate*: ``vestahub/legacy_status.py``
...
from vestahub import legacy_alias_telemetry as telemetry
from vestahub.legacy_alias_telemetry import (
    STATE,
    STATUS,
    coverage_report,
    removal_candidates,
...
from vestahub.run_state import RunState, canonical_for
...
class ObservationTests(unittest.TestCase):
    ...
    def test_a_legacy_status_is_observed_through_the_import_adapter(self) -> None:
        # The second chokepoint: vestahub/legacy_status.py's status->state map.
...
class RemovalCandidateTests(unittest.TestCase):
    ...
    def test_every_declared_alias_is_a_candidate_before_anything_runs(self) -> None:
        from vestahub.generated_lifecycle import LEGACY_STATE_MAP, LEGACY_STATUS_MAP
...
class CoverageReportTests(unittest.TestCase):
    ...
    def test_the_report_quotes_the_existing_gate_rather_than_inventing_one(
        ...
        from vestahub.legacy_status import REMOVAL_GATE
    ...
    def test_the_aggregate_surface_exposes_the_per_alias_detail(self) -> None:
        ...
        from vestahub.legacy_status import legacy_status_usage
