...
(:func:`opaihub.local_runner.PaidAPIRunner.cost_usd`).
...
``opaihub/provider_catalog.py`` treats an expired price snapshot.
"""
...
def estimate_cost_usd(
    ...
    *,
    ...
    only caller with no "unknown" slot — ``opaihub.ledger.record_model_call``
