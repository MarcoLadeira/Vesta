...
``OPAI_STARTUP_TRACE`` environment flag, and the trace is appended to a JSONL
...
TRACE_ENV = "OPAI_STARTUP_TRACE"
_TRUTHY = {"1", "true", "yes", "on"}


def trace_enabled(env: dict[str, str] | None = None) -> bool:
    """True only when the local ``OPAI_STARTUP_TRACE`` flag is explicitly set."""
