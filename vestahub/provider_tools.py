...
class RepositoryToolExecutor:
    ...
    def _record_guard_decision(
        ...
        the first live-run wiring of vestahub.audit's tamper-evident trail --
    ...
    def _mutation_gate(
        ...
        scope = planned_paths or (".vestahub/repository-safety-boundary",)
        try:
            require_mutation_permitted(
                self._repository_handle,
                planned_paths=scope,
                operation=operation,
                vesta_owned_paths=tuple(self.written_paths),
            )
    ...
    def _git_commit(
        ...
        from vesta.authorship import with_coauthor
