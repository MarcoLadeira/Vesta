...
Vesta is the new brand for the OPcoding and Vesta Hub work. In 0.1.0 pre-alpha, Vesta is a local-first command layer over the existing coding workspace and hub registries.

## What Exists

- `vesta` CLI for install, scan, doctor, dashboard, and hub pass-through.
...
- Local `.vestahub/` state with dashboards, schedules, logs, generated MCP config, and project overlay.
