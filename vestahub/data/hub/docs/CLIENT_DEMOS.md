...
### Cline
- Vesta writes `.clinerules/vesta.md` and `.clineignore`.
...
### Gemini CLI
- Vesta writes `GEMINI.md`, `.geminiignore`, and `vesta-gemini` wrappers.
