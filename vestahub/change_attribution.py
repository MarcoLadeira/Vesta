...
class PathAttribution:
    ...
    def __post_init__(self) -> None:
        ...
        if classification in {"vesta_only", "overlapping"} and not operation_ids:
...
def _validate_producer_chain(
    ...
    *,
    ...
    if attribution.classification == "vesta_only" and pre_existing is not False:
        raise ValueError("vesta_only requires a complete clean baseline identity")
...
class ChangeSet:
    ...
    def __post_init__(self) -> None:
        ...
        for attribution in attributions:
            ...
            if attribution.classification in {"vesta_only", "overlapping"}:
    ...
    def attributed_paths(self) -> tuple[str, ...]:
        return tuple(
            ...
            if item.classification == "vesta_only"
        )
