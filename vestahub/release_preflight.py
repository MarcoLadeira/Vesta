...
from vesta.release_validation import validate_release_identity
...
def _default_tests(root: Path, candidate_sha: str) -> TestGateResult:
    ...
    with tempfile.TemporaryDirectory(prefix="vesta-release-tests-") as temporary:
