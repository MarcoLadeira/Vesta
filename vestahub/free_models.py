...
(``vestahub.gui_pipeline`` selects the first available free model) and what the
...
Relationship to ``vesta.model_registry`` (F2, QA E2E 2026-07-17): this module
owns the *operational* spec for the free tier — API base, env key, setup hint,
picker labels. ``vesta.model_registry._REGISTRY`` registers the same providers
