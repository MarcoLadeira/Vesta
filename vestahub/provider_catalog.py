...
def catalog_bytes() -> bytes:
    ...
    return resources.files("vestahub").joinpath(_CATALOG_RESOURCE).read_bytes()
...
def render_coverage_matrix() -> str:
    ...
    lines = [
        ...
        "`vestahub/data/provider_catalog/v1.json` by "
        "`vestahub.provider_catalog.render_coverage_matrix()`. Do not edit by hand. -->",
        "",
