...
from vesta.provider_contract import ERROR_CODES
...
CLAUSES: tuple[Clause, ...] = (
    ...
    Clause(
        ...
        "(`vesta.provider_contract.ERROR_CODES`), carrying a retryability flag.",
...
def _classify(outcome: Outcome) -> str:
    ...
    Reuses `vesta.provider_contract` rather than inventing a second taxonomy:
...
def _retryable(code: str) -> bool | None:
    ...
    """
    from vesta.provider_contract import _ERROR_SPECS
