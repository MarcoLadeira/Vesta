...
def run_build_request(
    ...
    *,
    ...
    from vesta.cli_stream import normalize_model_choice
    ...
    def _continuity(
        *,
        ...
        if checkpoint_id and final_status is not None:
            from vestahub.checkpoints import finalize_run_checkpoint
            from vestahub.workflow_state import relink_workflow_checkpoint
