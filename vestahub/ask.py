...
def run_explicit_model(
    ...
    *,
    ...
    # every provider round-trip (vestahub/local_runner.py). When that ran, the
    ...
    try:
        ...
        if use_tools and callable(complete_with_tools):
            ...
            # ledger entries (vestahub/local_runner.py); a runner without it
...
def _build_turn_guard(
    ...
    *,
    ...
    if callable(guard):
        return guard
    from vestahub.execution_guard import ExecutionGuard, ExecutionGuardContext
