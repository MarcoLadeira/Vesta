...
from the entry points in ``pyproject.toml``: ``vesta.exe``, ``op.exe``, and the
windowed ``Vesta-Desktop.exe`` behind the desktop icon. Each one hard-codes the
