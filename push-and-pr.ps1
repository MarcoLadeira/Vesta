...
#### 🆓 Free API model registry (``vestahub/free_models.py``)
...
#### 🔌 FreeAPIRunner (``vestahub/local_runner.py``)
...
#### 🏷️ Descriptive model labels (``vesta/provider_contract.py``)
...
#### 📂 Grouped model picker (``vesta/assets/web/app.js``)
...
- ``vesta/assets/web/__tests__/e2e/free-models.spec.js`` — 7 E2E tests (optgroups, disabled state, label suffix, ordering)
- ``vesta/assets/web/__tests__/e2e/model-mode.spec.js`` — updated to assert optgroup headings
